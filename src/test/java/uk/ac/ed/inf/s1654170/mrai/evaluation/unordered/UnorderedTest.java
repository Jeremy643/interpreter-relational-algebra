//package uk.ac.ed.inf.s1654170.mrai.evaluation.unordered;
//
...
//		String expectedPath = System.getProperty("user.dir") + "/src/test/java/uk/ac/ed/inf/s1654170/mrai/evaluation/unordered/";
...
//		Table table = new Table(sig, bags);
...
//		expected.add(Record.valueOf(sportStudentSig.getTypes(), "14", "Sean", "s3"));
//		expected.add(Record.valueOf(sportStudentSig.getTypes(), "15", "Sarah", "s4"));
//		expected.add(Record.valueOf(sportStudentSig.getTypes(), "18", "Hamish", "s6"));
...
//		RAExpr e = new Union(new Base("SportStudents"), new Base("Students"));
//		Table expected = getExpectedTable(e.toString());
//		assertEquals(expected, e.execute(dbBags));
//	}
//
...
//		RAExpr e = new Intersect(new Base("DetentionStudents"), new Base("Students"));
//		Table expected = getExpectedTable(e.toString());
//		assertEquals(expected, e.execute(dbBags));
//	}
//	
...
//		// Parents <X> City
//		RAExpr e = new Product(new Base("City"), new Base("Parents"));
//		Table expected = getExpectedTable(e.toString());
//		assertEquals(expected, e.execute(dbBags));
//	}
//	
